const apiURL = 'https://api.openweathermap.org/data/2.5/weather?lat=42.0371544&lon=111.395956&units=imperial&APPID=88b895fa4815bc85c2b6ee08540fbf86';
...
.then((jsObject) => {
    ...
    while (k < 5 && i < jsObject.list.length) {
